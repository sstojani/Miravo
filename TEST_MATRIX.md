...
| Localization | Every implemented user string exists in English and Albanian | `check-localizations.sh` and 264-key coverage/format check | Native-speaker review | passing-local |
