...
| Localization | Every implemented user string exists in English and Albanian | `check-localizations.sh` and 356-key coverage/format check | Native-speaker review | passing-local |
