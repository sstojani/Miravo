...
- The owner retested `ca09515` on an iPhone: all four Your ledger links still freeze. The prior accessibility containment change did not resolve navigation. The parent Settings screen now uses a grouped ScrollView while preserving the existing destinations and controls; native navigation verification is pending.
